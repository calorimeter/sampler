...
class B4cCalorHit : public G4VHit
{
  ...
  private:
    ...
    G4ThreeVector fPos;    ///Position of particle at time of hit
};
...
inline void B4cCalorHit::SetPosition(G4ThreeVector& pos) {
  fPos = pos;
}
...
inline G4ThreeVector B4cCalorHit::GetPosition() const {
  return fPos; //Non-pointer so should implicitly call copy constructor
}
